...
public class Class6Client : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            SendMessageToHost(ClientToServerSignifiers1.CreateAccountAttempt+","+"Shaw"+","+"abc123");
        }
        else if (Input.GetKeyDown(KeyCode.L))
        {
            SendMessageToHost(ClientToServerSignifiers1.LoginAttempt +","+"Shaw"+","+"abc123"); 
        }
